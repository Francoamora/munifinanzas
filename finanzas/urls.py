...
urlpatterns = [
    ...
    path('movimientos/<int:pk>/recibo/', views.ReciboIngresoPrintView.as_view(), name='movimiento_recibo_print'), 
    ...
    # =========================================================
    # 🚀 COMPRAS Y MÓDULO TRIBUTARIO (DReI)
    # =========================================================
    # Ficha Administrativa de Proveedores
    ...
    # --- MÓDULO DREI Y PADRÓN ---
    # 🚀 FIX: Agregada la ruta para la lista global del Padrón DReI
    path("padron-drei/", views.PadronDreiListView.as_view(), name="padron_drei_list"),
    # Expediente individual
    path("proveedores/<int:pk>/drei/", views.ProveedorDreiPanelView.as_view(), name="proveedor_drei_panel"),
    # 🚀 FIX: Corregido el nombre de la URL para que coincida con el template
    path("proveedores/<int:pk>/drei/nueva-ddjj/", views.DDJJDreiCreateView.as_view(), name="proveedor_ddjj_create"),

    # 🚀 AGREGAMOS LA RUTA DE IMPRESIÓN ACÁ:
    path("drei/boleta/<int:pk>/imprimir/", views.LiquidacionDreiPrintView.as_view(), name="drei_boleta_print"),

    # 🚀 RUTA DEL CHECKOUT DE COBRO:
    path("drei/boleta/<int:pk>/cobrar/", views.LiquidacionDreiCobrarView.as_view(), name="drei_boleta_cobrar"),
...
if has_oc:
    urlpatterns += [
        ...
        path("api/oc/beneficiario-quick-create/", views_oc.api_beneficiario_create, name="api_beneficiario_create"), 
